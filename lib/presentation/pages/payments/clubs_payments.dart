...
class MesClubsPage extends StatefulWidget {
  const MesClubsPage({Key? key}) : super(key: key);

  @override
  State<MesClubsPage> createState() => _MesClubsPageState();
}

class _MesClubsPageState extends State<MesClubsPage> {
  int _selectedIndex = 0;

  final List<Map<String, dynamic>> clubs = [
    {'title': "Club de Musique", 'amount': "500/500", 'status': 'paid'},
    {'title': "Club de Lecture", 'amount': "0/500", 'status': 'unpaid'},
    {'title': "Club Robotique", 'amount': "120/500", 'status': 'partial'},
  ];
