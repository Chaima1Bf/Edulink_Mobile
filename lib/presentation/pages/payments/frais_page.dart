...
class FraisPage extends StatefulWidget {
  const FraisPage({Key? key}) : super(key: key);

  @override
  State<FraisPage> createState() => _FraisPageState();
}

class _FraisPageState extends State<FraisPage> {
  ...
  final List<Map<String, dynamic>> fraisData = [
    {'month': 'Septembre', 'amount': '500/500', 'status': 'paid'},
    {'month': 'Octobre', 'amount': '350/500', 'status': 'partial'},
    {'month': 'Novembre', 'amount': '500/500', 'status': 'paid'},
    {'month': 'Décembre', 'amount': '500/500', 'status': 'partial'},
    {'month': 'Janvier', 'amount': '0/500', 'status': 'unpaid'},
    {'month': 'Février', 'amount': '500/500', 'status': 'partial'},
  ];

  final Map<String, dynamic> statusStyles = {
    'paid': {
      'image': 'assets/images/payed.png',
      'monthColor': Color(0xFF173021),
      'amountColor': Color(0xFF73B387),
    },
    'unpaid': {
      'image': 'assets/images/not_payed.png',
      'monthColor': Color(0xFF2D2C29),
      'amountColor': Color(0xFFDE584E),
    },
    'partial': {
      'image': 'assets/images/part_payed.png',
      'monthColor': Color(0xFF40362B),
